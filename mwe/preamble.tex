...
\renewcommand{\maketitle}{%
    ...
    \end{flushright}%
    {\hfill  \Huge \textsc{\textbf{\thetitle}} \hfill }
    \par%
    \vspace{0.2\headerlogoheight}
    \begin{wrapfigure}{l}{0.3\linewidth}%
        \vspace{-1.4\baselineskip}
        \begin{minipage}[t][0mm][t]{\linewidth}
            \noindent
            \centering
            \ifthenelse{\boolean{myfaceset}}{ \includegraphics[width=\linewidth]{\myfacepath}}%
            {\missingfigure[figwidth=\linewidth]{}}{}\\%
            \ifthenelse{\boolean{myfaceset}}{\large\textsc{\textbf{\color{oxfordblue}\theauthor}}}{Specifcy where to find your picture using \texttt{\textbackslash{}myface\{\}}. \\ \vspace{1\baselineskip}
                \textbf{\theauthor}}
        \end{minipage}%
